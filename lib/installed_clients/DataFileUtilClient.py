...
class DataFileUtil:
    ...
    def pack_file(self, params, context=None):
        ...
        """
        return self._client.run_job("DataFileUtil.pack_file", [params], self._service_ver, context)
    ...
    def save_objects(self, params, context=None):
        r"""Save objects to the workspace. Saving over a deleted object undeletes
        it.
    ...
    def versions(self, context=None):
        ...
        """
        return self._client.run_job("DataFileUtil.versions", [], self._service_ver, context)
    ...
    def status(self, context=None):
        return self._client.run_job("DataFileUtil.status", [], self._service_ver, context)
