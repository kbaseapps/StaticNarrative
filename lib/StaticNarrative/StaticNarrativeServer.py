...
from StaticNarrative.StaticNarrativeImpl import StaticNarrative  # noqa @IgnorePep8
impl_StaticNarrative = StaticNarrative(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'StaticNarrative'
        ...
        self.rpc_service.add(impl_StaticNarrative.create_static_narrative,
                             name='StaticNarrative.create_static_narrative',
                             types=[dict])
        self.method_authentication['StaticNarrative.create_static_narrative'] = 'required'  # noqa
        self.rpc_service.add(impl_StaticNarrative.get_static_narrative_info,
        ...
        self.rpc_service.add(impl_StaticNarrative.status,
                             ...
                             types=[])
        self.method_authentication['StaticNarrative.status'] = 'none'  # noqa
