...
* [`requirements.txt`](requirements.txt) - packages required for runtime
* [`requirements-test.txt`](requirements-test.txt) - packages used in testing and generating coverage, and code linting and formatting.
...
* [`create_static_narrative.py`](scripts/create_static_narrative.py) - generate the HTML and data files for the static narrative locally
* [`fetch_test_narrative.py`](scripts/fetch_test_narrative.py) - retrieve the data objects and reports for a given narrative
